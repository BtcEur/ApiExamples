...
/* Example "Deactivate orders" request */

$data["orders"][0] = array("id" => 24261, "block" => 1);
$data["orders"][1] = array("id" => 24251, "block" => 1);
// orders array must be json encoded!!!
$blockOrdersArray = json_encode($data);

echo '<pre>';
print_r(jsonCurlRequest($api_url, $user_number.':'.$api_key, $blockOrdersArray));
echo '</pre>';
@ob_end_flush();
